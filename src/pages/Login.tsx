...
// WhatsApp numarasını uluslararası formatta gir (başında 0 olmadan, boşluksuz)
// Örnek: "905321234567" → +90 532 123 45 67
const WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER as string || "905XXXXXXXXX";
const SUPPORT_EMAIL   = import.meta.env.VITE_SUPPORT_EMAIL   as string || "destek@takimax.com";
                  ...
                  <div className="form-animate">
                    ...
                    {forgotState === "found" && (
                      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                        ...
                        <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Merhaba, " + forgotEmail + " hesabımın şifresini sıfırlamak istiyorum.")}`} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 16px", background: "#25D366", borderRadius: 8, textDecoration: "none" }}>
                        ...
                        <a href={`mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent("Şifre Sıfırlama")}&body=${encodeURIComponent("Merhaba,\n\n" + forgotEmail + " hesabımın şifresini sıfırlamak istiyorum.")}`} style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 16px", border: "1.5px solid #e8e3dc", borderRadius: 8, textDecoration: "none", background: "#fff" }}>
                          ...
                          <div><p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 12, fontWeight: 700, color: "#111", margin: 0 }}>E-posta Gönder</p><p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 11, color: "#888", margin: 0 }}>{SUPPORT_EMAIL}</p></div>
                        </a>
