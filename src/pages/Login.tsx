                ...
                {mainTab === "giris" && (
                  <div className="form-animate">
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <SocialBtn onClick={async () => { const r = await loginWithGoogle(); if (r.success) navigate("/"); else alert(r.error); }}>
                      ...
                      <SocialBtn onClick={async () => { const r = await loginWithFacebook(); if (r.success) navigate("/"); else alert(r.error); }}>
